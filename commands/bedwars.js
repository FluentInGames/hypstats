...
module.exports = {
    name: "bedwars",
    async execute(message, args, methods, playerInfo) {
    ...
    async help(message, args) {
        let embed = new discord.MessageEmbed()
            .setTitle("Bedwars Command")
            .addField("Description", "Gets a player's Bedwars stats including Level, FKDR and Wins.")
            .addField("Usage", "```;bw <username>```")
